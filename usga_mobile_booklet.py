...
# --- Page Config ---
st.set_page_config(page_title="USGA U.S. Open Player Memo", layout="wide", page_icon="🏌️")
...
st.markdown("<div class='title'>🏌️ 2025 U.S. Open Player Memo</div>", unsafe_allow_html=True)
